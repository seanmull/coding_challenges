...
def is_in_cache(
    host="localhost", port=6379, db=0, key=None, set_key=None, set_value=None
):
    """
...
def get_object_from_cache(host="localhost", port=6379, db=0, key=None):
    """
    Retrieves a serialized JSON object from the Redis cache and deserializes it into a Python object.
